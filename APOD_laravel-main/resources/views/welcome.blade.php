      ...
      <div id="modal" class="hidden fixed z-10 inset-0 overflow-y-auto">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            ...
            class="mt-4 text-blue-600 hover:text-blue-800">HD-Bild ansehen →</a>
          </div>
          <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            <button type="button"
            class="w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm" onclick="closeModal()">Schließen</button></div>
        </div>
    ...
    <script>
        ...
        async function loadData() {
            ...
            try {
                ...
                card.className = 'flex flex-col items-center bg-white rounded-xl shadow-lg hover:shadow-2xl transition p-6 cursor-pointer';
                card.innerHTML = `
                    ...
                    <button class="mt-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onclick="openModal('${apod.title}', '${apod.explanation}', '${apod.hdurl}')">Mehr lesen</button>
                    <div class="mt-4">

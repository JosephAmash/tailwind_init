...
<head>
    ...
    <title>Eintrag anzeigen - Mein Digitales Tagebuch</title>
    <link href="<https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css>" rel="stylesheet">
</head>
<body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold mb-8">Eintrag anzeigen - Mein Digitales Tagebuch</h1>
        ...
        <a href="{{ route('diary.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-4 inline-block">Eintrag anzeigen</a>
